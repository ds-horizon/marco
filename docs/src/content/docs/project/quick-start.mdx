...
1.  Add `marco` to project.
    ...
    <Tabs syncKey="package-manager">
      <TabItem label="yarn" icon="seti:yarn">
        ```sh frame=none yarn add @d11/marco ```
      </TabItem>
      <TabItem label="npm" icon="seti:npm">
        ```sh frame=none npm install @d11/marco ```
      </TabItem>
    </Tabs>
...
5.  Run the following command from the CLI to fetch data from the device and save it to the specified path.
    ...
    <Tabs syncKey="package-manager">
      <TabItem label="yarn" icon="seti:yarn">
        ```sh frame=none yarn marco generate ```
      </TabItem>
      <TabItem label="npm" icon="seti:npm">
        ```sh frame=none npm marco generate ```
      </TabItem>
    </Tabs>
...
🎉 Yeah! We are done with first visualization.
