...
:::note
- By default, output path is set to `./marco-reports` and file path is set to `./marco-reports/log.json`.
- By default, data source path is set to `./marco-reports/log.json` but if need to visualize some other report, data source path can be changed.
:::
