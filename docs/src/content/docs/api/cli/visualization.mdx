...
- `-d, --dataDir <dataDir>`: Specify the directory containing the performance reports (default: ./marco-reports/log.json) & custom report name.
...
```bash frame="none"
yarn marco visualize --dataDir "./path/to/log.json:custome_report_name"
```
