...
Options:
  ...
  -d, --dataDir <dataDir>  Specify the data directory path
...
- `-d, --dataDir <dataDir>`: Specify the directory containing the performance reports (default: ./marco-reports/log.json).
