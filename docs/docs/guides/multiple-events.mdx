...
:::note Prerequisites
Before you begin, make sure you've gone through the [App Startup](/guides/app-startup) guide for basic setup and context.
:::
...
![Multiple Events Timeline](/img/multiple-events-timeline.png)

![Multiple Events Metrics](/img/multiple-events-metrics.png)

![Multiple Events Raw](/img/multiple-events-raw.png)
